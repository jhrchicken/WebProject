	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link"
				href="../UIUX/index.jsp"> <i class="fas fa-fw fa-tachometer-alt"></i>
				...
				<div id="collapsePages" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href=“../membership/login.do”>로그인</a> <a
							...
							class="collapse-item" href="forgot-password.jsp">비밀번호 찾기</a> <a
							class="collapse-item" href=“../membership/editProfile.do">프로필</a>
			...
			<!-- Nav Item - Q&Aboard -->
			<li class="nav-item"><a class="nav-link"
				href="../qnaboard/list.do"> <i class="fas fa-fw fa-table"></i> <span>Q&A게시판</span>
			</a></li>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							<div
								...
								<a class="dropdown-item" href="../membership/editProfile.do">
								...
								<a class="dropdown-item" href="../membership/logout.do"
				...
				<div class="container-fluid">
					...
					<p class="mb-4">Q&A게시판에 오신걸 환영합니다.</p>

					<!-- DataTales Example -->
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">${ qnaboardDTO.title }</h6>
						</div>
						<div class="card-body">
							<table border="1" width="100%" class="table table-bordered">
								...
								<tr>
									<td>작성일</td>
									<td>${ qnaboardDTO.postdate }</td>
									<td>조회수</td>
									<td>${ qnaboardDTO.visitcount }</td>
								</tr>
								<tr>
									<td>제목</td>
									<td colspan="3">${ qnaboardDTO.title }</td>
								</tr>
								<tr>
									<td>내용</td>
									<td colspan="3" height="100">${ qnaboardDTO.content }</td>
								</tr>
								<tr>
									<td colspan="4" align="center"><c:if
											test="${ qnaboardDTO.id == id }">
											<button type="button"
												onclick="location.href='../qnaboard/edit.do?num=${ param.num }';">
												수정하기</button>
											<button type="button"
												onclick="location.href='../qnaboard/delete.do?num=${ param.num }';">
												삭제하기</button>
										</c:if>
										<button type="button"
						...
						<table class="table table-bordered" width="100%" cellspacing="0">
							...
							<c:if test="${ not empty commentLists }">
								<c:forEach items="${ commentLists }" var="row" varStatus="loop">
									<c:if test="${ row.num == commentDTO.num }" var="editReply">
										<tr>
											<form method="post" action="../commentboard/edit.do"
												onsubmit="return validateForm(this);">
												<input type="hidden" name="ref"
													style="width: 150px;" value="${ qnaboardDTO.num }" />
												<input type="hidden" name="num"
													style="width: 150px;" value="${ commentDTO.num }" />
												<td align="center">${ id }</td>
												<td><input type="text" name="content"
													style="width: 100%;" value="${ commentDTO.content }" /></td>
												<td></td>
