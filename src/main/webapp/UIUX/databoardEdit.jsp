				...
				<div id="collapsePages" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="../membership/login.do">로그인</a> <a
							...
							Password</a> <a class="collapse-item"
							href="../membership/editProfile.do">프로필</a>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<p class="mb-4">자료실에 오신걸 환영합니다. 필요한 자료를 다운로드 하세요.</p>
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<div class="table-responsive">
								...
								<form method="post"
									enctype="multipart/form-data" action="../qnaboard/edit.do"
									onsubmit="return validateForm(this);">
									<input type="hidden" name="num" style="width: 150px;" value="${ dto.num }" />
									...
									<table border="1" width="100%"  class="table table-bordered">
										...
										<tr>
											<td>제목</td>
											<td><input type="text" name="title" style="width: 100%;"  value="${ dto.title }" />
											</td>
										</tr>
										<tr>
											<td>내용</td>
											<td><textarea name="content"
													style="width: 100%; height: 100px;">${ dto.content }</textarea></td>
										</tr>
										<tr>
											<td>첨부 파일</td>
