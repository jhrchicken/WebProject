							...
							<div class="table-responsive">
								...
								<table border="1" width="100%" class="table table-bordered">
									...
									<c:choose>
										...
										<c:otherwise>
											<c:forEach items="${ databoardLists }" var="row"
												varStatus="loop">
												<tr align="center">
													<!-- 가상번호 -->
													<td>${ map.totalCount - (((map.pageNum - 1) * map.pageSize) + loop.index) }</td>
													<td align="left"><a
														href="../databoard/view.do?num=${ row.num }">${ row.title }</a>
													</td>
													<td>${ row.id }</td>
													<td>${ row.visitcount }</td>
													<td>${ row.postdate }</td>
													<td><a
														href="../databoard/download.do?ofile=${ row.ofile }&sfile=${ row.sfile }&num=${ row.num }">[Download]</a>
													</td>
												</tr>
											</c:forEach>
										</c:otherwise>
								...
								<table border="1" width="100%" class="table table-bordered">
									<tr align="center">
										...
										<td width="100">
											<button type="button"
												onclick="location.href='../databoard/write.do';">글쓰기</button>
										</td>
									</tr>
								</table>
							</div>
