				...
				<div id="collapsePages" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href=“../membership/login.do”>로그인</a> <a
							...
							<a class="collapse-item" href=“../membership/editProfile.do">프로필</a>
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<form method="post"
								...
								<input type="hidden" name="id" style="width: 150px;" value="${ id }" />
								<table border="1" width="100%" class="table table-bordered">
									...
									<tr>
										<td colspan="2" align="center">
											...
											<button type="button"
												onclick="location.href='../freeboard/list.do';">목록</button>
										</td>
									</tr>
								</table>
							</form>
