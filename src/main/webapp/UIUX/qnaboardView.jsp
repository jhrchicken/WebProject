				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<table class="table table-bordered" width="100%" cellspacing="0">
							...
							<c:choose>
								<c:when test="${ empty commentLists }">
									<tr>
										<td colspan="6" align="center">댓글이 없습니다.</td>
									</tr>
								</c:when>
								<c:otherwise>
									<c:forEach items="${ commentLists }" var="row"
										...
										<tr align="center">
											...
											<td>
												<c:if test="${ row.id == id }">
													<button type="button"
												onclick="location.href='../commentboard/edit.do?ref=${ param.num }&num=${ row.num }';">
												수정</button>
													<button type="button"
												onclick="location.href='../commentboard/delete.do?ref=${ param.num }&num=${ row.num }';">
												삭제</button>
										</c:if>
											</td>
										</tr>
						...
						<table border="1" width="100%" class="table table-bordered">
							<tr align="center">
								...
								<td width="100">
									<button type="button"
										onclick="location.href='../commentboard/write.do?num=${ param.num}';">댓글 작성하기</button>
								</td>
							</tr>
						</table>
					</div>
