...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<!-- Nav Item - Dashboard -->
			<li class="nav-item"><a class="nav-link" href="../UIUX/index.jsp"> <i
				...
				<div id="collapsePages" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href=“../membership/login.do”>로그인</a> <a
							...
							class="collapse-item" href="forgot-password.jsp">비밀번호 찾기
							Password</a> <a class="collapse-item" href=“../membership/editProfile.do">프로필</a>
			...
			<!-- Nav Item - Freeboard -->
			<li class="nav-item"><a class="nav-link" href="../freeboard/list.do">
					<i class="fas fa-fw fa-table"></i> <span>자유게시판</span>
			</a></li>

			<!-- Nav Item - Q&Aboard -->
			<li class="nav-item"><a class="nav-link" href="../qnaboard/list.do">
					<i class="fas fa-fw fa-table"></i> <span>Q&A게시판</span>
			</a></li>

			<!-- Nav Item - Databoard -->
			<li class="nav-item"><a class="nav-link" href="../databoard/list.do">
					<i class="fas fa-fw fa-table"></i> <span>자료실</span>
			</a></li>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							<div
								...
								<a class="dropdown-item" href=“../membership/editProfile.do"> <i
								...
								<a class="dropdown-item" href=“../membership/logout.do" data-toggle="modal"
				...
				<div class="container-fluid">
					...
					<p class="mb-4">Q&A 게시판에 오신걸 환영합니다. </p>
						...
						<div class="card-body">
							<div class="table-responsive">
								...
								<table class="table table-bordered" width="100%" cellspacing="0">
									...
									<c:choose>
										<c:when test="${ empty qnaboardLists }">
											<tr>
												<td colspan="6" align="center">등록된 게시물이 없습니다.</td>
											</tr>
										</c:when>
										<c:otherwise>
											<c:forEach items="${ qnaboardLists }" var="row"
												varStatus="loop">
												<tr align="center">
													<!-- 가상번호 -->
													<td>${ map.totalCount - (((map.pageNum - 1) * map.pageSize) + loop.index) }</td>
													<td align="left"><a
														href="../qnaboard/view.do?num=${ row.num }">${ row.title }</a>
													</td>
													<td>${ row.id }</td>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a class="btn btn-primary" href="../membership/logout.do">로그아웃</a>
				</div>
			</div>
		</div>
	</div>
