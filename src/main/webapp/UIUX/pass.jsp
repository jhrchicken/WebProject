...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
				...
				<div id="collapsePages" class="collapse show"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="login.jsp">Login</a> <a
							...
							Password</a> <a class="collapse-item active" href="profile.jsp">Profile</a>
            ...
            <!-- Nav Item - Q&Aboard -->
            <li class="nav-item">
                <a class="nav-link" href="qnaboard.jsp">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Q&A게시판</span></a>
            </li>
            ...
            <!-- Nav Item - Databoard -->
            <li class="nav-item">
                <a class="nav-link" href="databoard.jsp">
                    <i class="fas fa-fw fa-table"></i>
                    <span>자료실</span></a>
            </li>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<div class="p-5">
										...
										<form action="../membership/pass.do" method="post" class="user"
